  ...
  return (
    <main className="role-dashboard-shell">
      ...
      <section className="role-actions">
        <Link className="dashboard-button dashboard-button-primary" href="/doctor/calculator">
        ...
        {!isLoading ? (
          <form className="admin-doctor-form" onSubmit={handleSubmit}>
            ...
            <footer className="prevent-results-modal-actions">
              ...
              <Link className="dashboard-button dashboard-button-secondary" href="/doctor/calculator">
                Volver a la calculadora
              </Link>
            </footer>
          </form>
